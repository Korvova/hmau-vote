						...
						<div className="wrapper">
							...
							<div className="page__table">
								<table>
									...
									<tbody>
										<tr>
											<td>Большинство присутствующих депутатов</td>
											<td>Все пользователи онлайн x 50% &gt; За <br />За &gt; Против</td>
											<td className="accepted"><span><img src="/img/icon_27.png" alt="" />Не принято</span></td>
										...
										<tr>
											<td>Не менее 2/3 от установленного числа депутатов</td>
											<td>Все пользователи онлайн x 66,67% &gt; За <br />За &gt; Против</td>
											<td className="accepted"><span><img src="/img/icon_28.png" alt="" />Принято</span></td>
											<td className="action action-small">
												<ul>
													<li><a href="#!"><img src="/img/icon_24.png" alt="" /></a></li>
													<li><a href="#!"><img src="/img/icon_26.png" alt="" /></a></li>
										...
										<tr>
											<td>Большинство от установленного числа депутатов</td>
											<td>Все пользователи онлайн x 50% &gt; За <br />За &gt; Против</td>
											<td className="accepted"><span><img src="/img/icon_27.png" alt="" />Не принято</span></td>
											<td className="action action-small">
												<ul>
